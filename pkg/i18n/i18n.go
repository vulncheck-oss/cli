...
var En = Copy{
	...
	ScanScanPurlStartOffline:    "Scanning PURLs [OFFLINE]",
	ScanScanPurlProgress:        "Scanning PURLs [%d/%d]",
	ScanScanPurlProgressOffline: "Scanning PURLs [OFFLINE] [%d/%d]",
	ScanScanPurlEnd:             "Scanning PURLs: %d vulns found in %d packages",
	ScanScanPurlEndOffline:      "Scanning PURLs: [OFFLINE] %d vulns found in %d packages",
